...
num_classes = 3
dataset_root = 'C:/Users/smc/Desktop/CH/MARS_project/data/LDCT_png_image_100(cropped)_train'
test_dataset_root = 'C:/Users/smc/Desktop/CH/MARS_project/data/LDCT_png_image_100(cropped)_test'  # 테스트 데이터 폴더 경로
...
def train_model(model, train_loader, val_loader, epochs):
    ...
    # TensorBoard 로그 디렉토리
    log_dir = f"runs/ver16_NoFold-LDCT"
...
if __name__ == '__main__':
    ...
    plt.title('Confusion Matrix (Original CT)')
    plt.colorbar()
    ...
    plt.tight_layout()
    plt.savefig('confusion_matrix_test(Original).png')
    plt.close()

    print(f"Test Confusion Matrix:\n{test_cm}")

    # Best model 저장
    checkpoint_dir = os.path.join(f"runs/ver16_NoFold-LDCT", 'checkpoint')
    os.makedirs(checkpoint_dir, exist_ok=True)
    best_model_path = os.path.join(checkpoint_dir, 'weights-best_model.pth')
