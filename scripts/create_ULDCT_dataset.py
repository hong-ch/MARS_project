...
base_png_dir = "C:/Users/user1/Desktop/Changhee/project/LDCT_PNG"
# Base directory for the new dataset
new_dataset_dir = "C:/Users/user1/Desktop/Changhee/project/ULDCT_PNG"

# Create the new dataset directory if it doesn't exist
os.makedirs(new_dataset_dir, exist_ok=True)

# Iterate over each sub-directory (Normal, PN, TB)
for sub_dir in os.listdir(base_png_dir):
